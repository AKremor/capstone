...
static const uint16_t chopper_period = 30000;

static const uint16_t chopper_rising_dead_band_width = 100;
static const uint16_t chopper_falling_dead_band_width = 100;
