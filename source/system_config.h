...
static constexpr uint32_t pwm_period =
    system_clock_mhz * 1E6 / pwm_frequency_hz;
static constexpr uint32_t adc_frequency_hz = 10000;
static constexpr uint32_t adc_period =
    system_clock_mhz * 1E6 / pwm_frequency_hz;
